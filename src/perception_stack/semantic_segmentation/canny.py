...
class YOLOPCannyCandidates(Node):

    def __init__(self):
        super().__init__('yolop_canny_candidates_front')
        ...
        # ================= PARÁMETROS =================
        self.declare_parameter('canny_low_road', 60)
        ...
        #cv2.namedWindow('Lane Candidates Debug', cv2.WINDOW_NORMAL)
    ...
    def process(self):
        ...
        cv2.imshow('Lane Candidates Debug', vis)
