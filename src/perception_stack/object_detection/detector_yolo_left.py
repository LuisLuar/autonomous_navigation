...
class YoloDetectorLeft(Node):
    def __init__(self):
        super().__init__('yolo_detector_left')
        ...
        self.sub_image = self.create_subscription(
            Image, '/camera/rgb/left', self.callback_image, 1
        )
        self.pub_results = self.create_publisher(
            DetectionArray, '/detection/results_left', 1
        )
