...
class ImageCaptureNode(Node):
    ...
    def capture_image(self):
        ...
        if self.latest_image is None:
            #self.get_logger().warn("⚠️ No hay imagen disponible para capturar")
            return
    ...
    def keyboard_listener(self):
        ...
        #self.get_logger().info("⌨️  Escuchando teclas... (Presiona ESPACIO para capturar, 'q' para salir)")
        
        try:
            # Verificar si stdin es un terminal válido
            if not sys.stdin.isatty():
                #self.get_logger().warning("⚠️  No hay terminal disponible para leer teclas. Solo se aceptarán comandos por topic.")
                return
            ...
            #self.get_logger().warning(f"⚠️  No se pudo inicializar el listener de teclado: {e}")
